...
test.describe('Dashboard Navigation', () => {
  ...
  test('should display main navigation elements', async ({ page }) => {
    ...
    const drawerButton = page.locator('[data-testid="drawer-toggle"], .v-app-bar__nav-icon, button[aria-label*="menu"]').first()
  ...
  test('should open and close navigation drawer', async ({ page }) => {
    ...
    const drawerToggle = page.locator('[data-testid="drawer-toggle"], .v-app-bar__nav-icon, button[aria-label*="menu"]').first()
